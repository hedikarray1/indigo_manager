      ...
      >
        ...
        <View style={{ height: height / 3, justifyContent: 'center' }}>
          <TapGestureHandler onHandlerStateChange={this.onStateChange}>
            ...
            >
              <Text style={{ fontSize: 16, fontWeight: 'bold' }}>SE CONNECTER</Text>
            </Animated.View>

          </TapGestureHandler>

          <Animated.View style={{...StyleSheet.absoluteFill,...styles.inputs_form,    zIndex:this.textInputAIndex,
      opacity:this.textInputOpacity,transform:[{translateY:this.textInputTranslateY}]}}>
          <TapGestureHandler onHandlerStateChange={this.onCloseState}>
              ...
              <TextInput placeholder="nom d'utilisateur" style={styles.text_input}/>
